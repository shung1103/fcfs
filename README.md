...
- 특정 시간에 선착순 구매를 진행하는 프로젝트 특성 상 비관적 락을 거는 편이 낙관적 락에 비해 성능 상 유리
- 분산 락에 비교했을 때 tps 차이가 10이하로 나타나 **비관적 락을 사용하기로 결정**
...
| 상품 갯수 | 초기 | Cache + Pageable | 차이 |
| :-- | :-- | :-- | :-- |
| 10 | 650ms | 60ms | 약 10.8배 |
| 100 | 1372ms | 61ms | 약 22.5배 |
| 1,000 | 2628ms | 64ms | 약 41.1배 |

### 재입고 알림 메일 발송 비동기화

| 유저 수 | 초기 | 비동기화 적용 후 | 차이 |
| :-- | :-- | :-- | :-- |
| 10 | 2640ms | 1780ms | 약 1초 |
| 100 | 7053ms | 3650ms | 약 3.5초 |
